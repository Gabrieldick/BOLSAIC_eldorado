...
HD_PWD='D:/BOLSAIC_eldorado/Codigos/DisplayMaster_RTClkSlave/DisplayMaster_RTClkSlave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopFunc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopFunc.tcl -notrace
