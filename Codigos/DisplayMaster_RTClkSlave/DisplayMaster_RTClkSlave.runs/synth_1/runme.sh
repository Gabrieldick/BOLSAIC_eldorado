...
HD_PWD='D:/BOLSAIC_eldorado/Codigos/DisplayMaster_RTClkSlave/DisplayMaster_RTClkSlave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopFunc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopFunc.tcl
