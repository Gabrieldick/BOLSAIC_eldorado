...
HD_PWD='D:/BOLSAIC_eldorado/Codigos/slave/slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2CSLAVE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2CSLAVE.tcl
