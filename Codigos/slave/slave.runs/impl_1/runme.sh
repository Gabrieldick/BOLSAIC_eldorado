...
HD_PWD='D:/BOLSAIC_eldorado/Codigos/slave/slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2CSLAVE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2CSLAVE.tcl -notrace
