...
HD_PWD='D:/BOLSAIC_eldorado/Codigos/Master_and_slave/Master_and_slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_func.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_func.tcl -notrace
