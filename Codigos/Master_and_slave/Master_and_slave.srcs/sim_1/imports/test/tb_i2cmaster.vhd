...
begin
    ...
    TIC <= counter(7) and counter(5); -- Define a frequência para 300 kHz (~2.56 + 0.64 µs) para ~100 kbit
    ...
    begin
        nRST <= '0';
        SRST <= '0';
        -- Defina o endereço do escravo como 0x38 durante a transmissão do endereço
        DIN <= x"38"; -- Define o endereço do escravo como 0x38
        wait for 1000 ns;
        nRST <= '1';
